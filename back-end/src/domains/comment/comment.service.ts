...
export class CommentService {
    ...
    create = async (createCommentDto: CreateCommentDto, request: Request, postId: number) => {
      try {
        return await createComment(createCommentDto, request, postId, this.prismaService);
      } catch (error) {
        throwError(error);
      }
    };
